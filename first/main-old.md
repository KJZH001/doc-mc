...
然后找到 Java | Oracle （通常第一个就是，域名为 www.java.com ）

Snipaste 2020 02 14 14 05 47
点进去以后将网址 https://www.java.com/zh_CN/ 中的 zh_CN 改为 en

或者直接点这里 https://www.java.com/en/

下载你的java运行环境
现在，点击位于标题栏最上方中央的Download，然后页面拉到最下面，找到 See all Java downloads

Snipaste 2020 02 14 14 18 42
现在向下拉，找到图中的内容位置，然后按图里选

Snipaste 2020 02 14 14 22 49
第一个是在线安装，不建议使用，至于为啥你试试就知道了

接下来下完了打开，这时候你看到的都是中文了，然后该同意的同意，然后一直无脑下一步就行，千万不要改安装位置，否则很容易出问题！一定要改的出了问题别来问！
